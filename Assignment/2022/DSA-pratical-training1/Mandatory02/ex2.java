...
public class Sample2 {
    ...
    // B提出のコメントでは、この代入で何がおきるかを説明してください。
		// aという変数から参照されることにより、アクセスが可能になっている配列と同じ配列にbという変数から参照してアクセスが可能になった。
	...
	//	特に、a の要素の出力結果に注意をはらってください。
		// cの要素の出力結果は０以上の３の倍数が小さい順に１０個となる。bの要素の出力結果は０以上の２の倍数が小さい順に３個となる。aの要素の出力結果はaから参照されることによりアクセスできる配列がbから参照されることによりアクセスできる配列と同じなのでbと同じになる。
	...
	//a,bの参照する配列の要素に６という値をもつものはないから。
		...
		/* 記入コード（５）*/
		System.out.println("result of search of a = " + linearsearch(c, 6));
    ...
    // どうしてそういう出力になるかを説明してください。
		//dの参照する配列に順番に５，６，７，８，９，１０，１１，１２が代入されるから。
